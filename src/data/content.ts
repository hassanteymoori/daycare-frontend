...
export const galleryShots = [
  {
    ...
    caption: 'Songs, storytelling, and a warm welcome for every child.',
  },
  {
    title: 'Outdoor Discovery',
    caption: 'Nature play in a safe private yard with guided activities.',
  },
  {
  ...
  {
    title: 'Family Update',
    caption: 'Daily photos and notes shared through our parent app.',
  },
]
